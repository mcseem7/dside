...
export default ({ config, onSubmit }) => {
    ...
    return <section className="step-first step-container">
        <div className="pricing__wrapper">
            ...
            <div className='pricing pricing-palden'>
                {take(3, selectedSevice.packs).map((pack, packIndex) => <div className={'pricing-item ' + ((packIndex === 3) ? 'elite' : '')}>
    ...
    <div className="pricing-item elite">
                        <div className="pricing-deco elite">
                            ...
                            <button className='elite-btn' onClick={() => onSubmit({ packIndex: 3, serviceIndex: index })}>{useLang(orderLang)}</button>
                        </div>
