                ...
                <div className='video-wrap'>
                    ...
                    <div id="vidtop-content">
                        <HeaderService
                            ...
                            serviceSlogan={[<Fragment><Translate>DSIDE to make your logo work</Translate> <br /> <Translate>BETTER</Translate></Fragment>]}
                            serviceCategory={'Logo'} />
                    </div>
                </div>

                <section className="logo__service-case_studies" style={{background: '#fff'}}>
